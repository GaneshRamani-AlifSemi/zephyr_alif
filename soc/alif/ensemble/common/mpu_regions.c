...
#define MRAM_WRITABLE_END		(MRAM_STORAGE_PARTITION_ADDR + MRAM_STORAGE_PARTITION_SIZE)
#define MRAM_HAS_STORAGE_PARTITION	1
#else
#define MRAM_STORAGE_PARTITION_ADDR	(MRAM_SCRATCH_PARTITION_ADDR + MRAM_SCRATCH_PARTITION_SIZE)
#define MRAM_STORAGE_PARTITION_SIZE	0
#define MRAM_WRITABLE_END		MRAM_STORAGE_PARTITION_ADDR
#define MRAM_HAS_STORAGE_PARTITION	0
#endif
...
#define DEVICE_MRAM_SIZE	(MRAM_WRITABLE_END - MRAM_SLOT0_PARTITION_ADDR)
#define MRAM_HAS_DEVICE_REGION	1
...
#define DEVICE_MRAM_BASE_ADDR	(MRAM_SLOT0_PARTITION_ADDR + MRAM_SLOT0_PARTITION_SIZE \
						- MRAM_SECTOR_SIZE)
#define DEVICE_MRAM_SIZE	(MRAM_WRITABLE_END - DEVICE_MRAM_BASE_ADDR)
#define MRAM_HAS_DEVICE_REGION	1
#else
/*
...
#define MRAM_HAS_DEVICE_REGION	MRAM_HAS_STORAGE_PARTITION
#endif
